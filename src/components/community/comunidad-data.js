export default  () => {
    ...
    return[
        ...
        },
        {
            ...
            job:"seminuevos.com",
            text:"Dev.f me abrió las puertas al mundo startupero de México, el cual no sabía que existía, lleno de gente i" +
            "nnovadora y talentosa. Aquí aprendí un nuevo idioma que en mis experiencias en negocios no había conocido: el " +
            "tecnológico. ¡Cualquiera de los programas es una experiencia que vale tomar!. "
        },{
            ...
            text:"En Dev.f puede encontrar aparte de conocimiento, personas que me aportaron mucho en mi persona y " +
            "conocí mucho más de lo que ofrece el curso en sí. Una experiencia genial y única."
        },{
            name:"Luis Trujillo",
            job:"ITESM & TokTok.",
